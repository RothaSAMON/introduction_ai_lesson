import sys
from PyQt6.QtWidgets import (QApplication, QWidget, QGridLayout, QLineEdit, QPushButton, QMessageBox, QHBoxLayout, QVBoxLayout, QLabel)
    ...
    def __init__(self):
        ...
        for row in range(9):
            for col in range(9):
                ...
                cell.setMaxLength(1)
                cell.setStyleSheet("font-size: 16px; color: black;")
        ...
        new_button.setStyleSheet("color: black;")
